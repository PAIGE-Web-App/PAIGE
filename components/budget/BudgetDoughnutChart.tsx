    ...
    <div className={`relative w-full h-full flex flex-col items-center justify-center group ${className}`}>
      ...
      <div className="relative w-20 h-20 mt-2">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className={`text-sm font-semibold ${isOverBudget ? 'text-red-500' : 'text-[#332B42]'}`}>
      ...
      {/* Helper text - now positioned below the chart */}
      <div className="text-center mt-3">
        <div className="text-xs text-[#AB9C95] whitespace-nowrap">
