...
interface TableEditModalProps {
  isOpen: boolean;
  table: TableType;
  onSave: (updatedTable: Partial<TableType>) => void;
  onCancel: () => void;
}
...
export const TableEditModal: React.FC<TableEditModalProps> = ({
  ...
  const [tableData, setTableData] = useState({
    name: table.name,
    type: table.type as keyof typeof DEFAULT_CAPACITIES,
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <h5 className="h5 text-[#332B42]">Edit Table</h5>
              <button
                onClick={handleClose}
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-600 text-left">
                Update your table configuration. You can change the table type, capacity, name, and description.
              </p>
            </div>
                ...
                {TABLE_TYPES.map((type) => (
                  <button
                    ...
                    onClick={() => setTableData(prev => ({ 
                      ...
                      // Reset capacity to first option when type changes
