...
export default function IdleTimeoutManager() {
  ...
  const timeoutMinutes = parseInt(process.env.NEXT_PUBLIC_IDLE_TIMEOUT_MINUTES || '30');
  const warningMinutes = parseInt(process.env.NEXT_PUBLIC_IDLE_WARNING_MINUTES || '5');
