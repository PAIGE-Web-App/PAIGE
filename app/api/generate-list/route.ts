...
async function handleTodoGeneration(req: Request) {
  try {
    ...
    prompt += `IMPORTANT: Create a unique and descriptive list name that clearly represents the content. Avoid generic names like "Wedding Checklist" or "To-Do List". Make it specific to the user's description and wedding context.\n`;
    if (weddingDate) {
