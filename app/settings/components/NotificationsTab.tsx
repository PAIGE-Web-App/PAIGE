  ...
  return (
    <div className="flex gap-8 pb-8">
      <div className="flex-1 bg-white rounded-lg p-6 shadow">
        ...
        <div className="mb-8">
          <h3 className="text-md font-semibold mb-4 text-[#332B42]">External Notifications</h3>
        ...
        <div className="mb-8">
          <h3 className="text-md font-semibold mb-4 text-[#332B42]">In-App Notifications</h3>
          <p className="text-sm text-[#7A7A7A] mb-6">
