/**
 * Final test for the PAIGE Message Analysis N8N Webhook
 */
...
// Test with proper wedding planning message
const testData = {
...
async function testMessageAnalysis() {
  console.log('🧪 Testing Message Analysis with Real Wedding Data...');
