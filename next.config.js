...
const nextConfig = {
  ...
  outputFileTracingExcludes: {
    '*': [
      ...
      'scripts',
      '*.md',
      // Exclude unused large images from serverless functions (keep only used ones)
      'public/Assign.png',
      'public/Assigned.png',
      'public/BasicBlank.png',
      'public/BudgetNew.png',
      'public/FavSmall.png',
      'public/Final.png',
      'public/PCircle.png',
      'public/Paige.png',
      'public/PaigeSquare.png',
      'public/Quick Start.png',
      'public/Venue-optimized.png',
      'public/Venue.png',
      'public/Welcome.png',
      'public/aimessage.png',
      'public/appbg.png',
      'public/appbg2.png',
      'public/better.png',
      'public/bg2.png',
      'public/bgdash.png',
      'public/bglight.png',
      'public/budget-optimized.png',
      'public/budgetplan.png',
      'public/couple.png',
      'public/couplepaige.png',
      'public/coupleseated.png',
      'public/file manager.png',
      'public/finalbg.png',
      'public/finalbudget.png',
      'public/guests.png',
      'public/headdash.png',
      'public/heart-optimized.png',
      'public/loginsugnup.png',
      'public/pcirclealt.png',
      'public/photo2.png',
      'public/photo3.png',
      'public/photographer.png',
      'public/photographers.png',
      'public/plan.png',
      'public/pstarsbigger.png',
      'public/rings.png',
      'public/rings.svg',
      'public/ringsonboarding.png',
      'public/seating.png',
      'public/todophoto.png',
      'public/todos.png',
      'public/vibe-optimized.png',
      'public/vibegen.png',
      'public/weather-optimized.png',
      'public/wedbudget.png',
      'public/wine.png',
    ],
    '/api/**': [
      // Exclude unused large images from API routes (keep only used ones)
      'public/Assign.png',
      'public/Assigned.png',
      'public/BasicBlank.png',
      'public/BudgetNew.png',
